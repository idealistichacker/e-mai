...
| 功能模块 | 状态 | 说明 |
|---------|------|------|
| **全局导航栏** | ✅ | 顶部导航，包含菜单项：首页、计划中心、文化地图、文创商城、社区互动 |
| **地域侧边栏** | ✅ | 左侧，展示4大文化区，可点击选择 |
| **计划选择器** | ✅ | 切换"青苗计划"、"归雁计划"、"桑榆计划" |
| **内容矩阵** | ✅ | 二维网格，纵轴：学段（小学、初中、高中、大学）；横轴：课程卡片 |
| **课程卡片** | ✅ | 显示课程信息，图片区使用彩色占位符，预留 `imageUrl` 字段 |
